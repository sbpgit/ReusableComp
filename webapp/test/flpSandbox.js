		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "reusableComp",
									"targetURL": "#reusereusablecomp-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"reusereusablecomp-display": {
								"semanticObject": "reusereusablecomp",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=reuse.reusablecomp",
									"url": sap.ui.require.toUrl("reuse/reusablecomp")
								}
							}
						}
					}
